@echo off
title Automatisation des manips + opti + tweaks sur Windows 11 pour les PC Fixes - Robin
mode con: cols=120 lines=40

echo ================================================================
echo Automatisation des manips + opti + tweaks sur Windows 11 pour les PC Fixes
echo ' - Robin
echo ================================================================
echo.
...
:: -----------------------------------------------------------
:: CREATION DU .REG INTERNE SANS POWERSHELL
:: -----------------------------------------------------------
set "REGFILE=%TEMP%\capet_opti_windows11.reg"

(
echo Windows Registry Editor Version 5.00
echo.
echo ;=== OPTIMISATIONS BUREAU & GAMING (Xander + CAPET)
echo.
...
:: SERVICES
:: -----------------------------------------------------------
echo Desactivation de SysMain, DPS, TabletInputService, RmSvc...
...
:: Spooler NON modifié pour garder l’imprimante OK
...
echo  Redemarre ton PC pour appliquer tous les changements.
echo ================================================================
echo.
pause
exit /b
